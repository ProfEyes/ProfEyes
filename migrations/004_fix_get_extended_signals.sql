-- =============================================
-- CORREÇÃO: get_extended_signals() 
-- =============================================
-- Data: 2026-01-24
-- Problema: Sinais adicionais (posições 4-7) sempre começavam de 02:03,
--           causando exibição de sinais desatualizados
-- Solução: Calcular próximo horário válido baseado no último sinal ativo
--          e ajustar expires_at para usar entry_time
-- =============================================
...
BEGIN
  ...
  -- ✅ VALIDAÇÃO: Se o horário calculado já passou, pular para o próximo
...
-- COMENTÁRIOS
-- =============================================
COMMENT ON FUNCTION public.get_extended_signals IS 'Retorna 7 sinais (3 ativos + 4 adicionais) com horários calculados dinamicamente baseados no horário atual';
